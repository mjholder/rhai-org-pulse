    ...
    <div class="relative">
      ...
      >
        <button
          ...
          class="w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center justify-between gap-4"
      ...
      <div v-if="isOpen && filteredVersions.length === 0" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg p-4 text-center text-gray-500">
        No versions found
      </div>
    </div>
  </div>
